...
import {Drawer, Hidden, ListItemText, TextField} from "@material-ui/core";
    ...
    const drawer = (
        <List>
            {options.map((option, index) => (
                <ListItem key={option} button selected={handleSelected(index)} onClick={() => handleListClick(index)}
            ...
            <section className={classes.section}>
                ...
                <nav>
                    <Hidden smUp implementation="css">
                        <Drawer variant="temporary" anchor="left" open={showDrawer} onClose={handleToggleDrawer}
